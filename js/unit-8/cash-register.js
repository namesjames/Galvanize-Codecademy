...
var me = new StaffMember("James",25);
...
cashRegister.scan('eggs',1cashRcashRegister.scan('milk',1cashRcashRegister.scan('magazine',3Register.applyStaffDiscount(me);
// Show the total bill
console.log('Yourl is '+cashRegister.total.toFixed(2));
